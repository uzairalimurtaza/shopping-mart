...
function ViewMoreTopRatedProducts() {
  ...
  var getData = async () => {
    try {
      ...
      const response = await BanglaBazarApi.post(
        `${Endpoint}/api/landing-page/topRatedProducts`,
        form
      );
      if (response.data.status) {
        setProducts(response.data.viewTopRatedProducts);
        setIsLoading(false);
        ...
        <>
          ...
          <div className="row mt-5">
            ...
            <div className="col-xl-9 col-md-9 col-sm-12 mt-3 m-auto">
              <h4 className="ftw-400 pb-3">Top Rated Products</h4>
...
export default ViewMoreTopRatedProducts;
